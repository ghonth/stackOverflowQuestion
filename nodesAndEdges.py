...
p = figure(width=1500, height=500, tools="pan,wheel_zoom,reset")
nonsel_color = '#f8faa2'
sel_color = 'orange'
nosel_color = '#42b9f5'
high_color = 'green'
...
sr1 = p1.segment(x0='x0', y0='y0', x1='x1', y1='y1', color='red', alpha=0.7, line_width=.5, source=source1)
sr2 = p1.segment(x0='x0', y0='y0', x1='x1', y1='y1', color='orange', alpha=0.7, line_width=.5, source=source2)
